...
public class DatabaseUtil extends JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        ...
        String[] dbs = new String[]{"wit_ccp"};

        for (String key : dbTypes) {
            this.jComboBox1.addItem(key);
        }
        for (String db : dbs) {
            this.jComboBox2.addItem(db);
        }
        setLocationRelativeTo(null);
    }
        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String password = jTextField2.getText();
                    String dbType = (String) jComboBox1.getSelectedItem();
                    String dbSelect = (String) jComboBox2.getSelectedItem();
                    DataBase db = new DataBase(dbType, ip, "3306", dbSelect);
                    db.setUserName(username);
                    db.setPassWord(password);
