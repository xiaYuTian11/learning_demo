package com.demo.code.entity.db;

//数据库实体类
public class DataBase {

    private static String mysqlUrl = "jdbc:mysql://[ip]:[port]/[db]?useUnicode=true&amp&characterEncoding=UTF8&allowMultiQueries=true&serverTimezone=GMT%2B8&useSSL=false";
    ...
    public DataBase(String dbType, String ip, String port, String db) {
        ...
        if ("MYSQL".equalsIgnoreCase(dbType.toUpperCase())) {
