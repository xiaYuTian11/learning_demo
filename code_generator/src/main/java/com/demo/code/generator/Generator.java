package com.demo.code.generator;

import cn.hutool.db.Db;
import com.demo.code.entity.Settings;
import com.demo.code.entity.db.DataBase;
import com.demo.code.utils.FileUtils;
...
public class Generator {
    ...
    private void executeGenertor(Map<String, Object> dataModel, File file) throws Exception {
        ...
        // String outFileName = templateFileName;
        //2.读取文件模板
    ...
    public static void main(String[] args) throws Exception {
        String templatePath = "E:\\download\\BaiduNetdiskDownload\\JavaEE\\C-传统行业解决方案SaaS-HRM项目\\IHRM项目\\day13-代码生成器实现\\day13-代码生成器实现\\资源\\SpringBoot模板";
        String outPath = "E:\\download\\BaiduNetdiskDownload\\JavaEE\\C-传统行业解决方案SaaS-HRM项目\\IHRM项目\\day13-代码生成器实现\\day13-代码生成器实现\\资源\\测试\\生成代码路径";
        Settings settings = new Settings("code", "com.demo.code", "项目描述", "tmw");
